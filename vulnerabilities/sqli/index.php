            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                      ...
                      <p><b>Note:</b> If the REST API is exhibiting "Unable to connect to the database. mysql_error()", please edit the api.php file located under \servicegoat\vulnerabilities\sqli</p>
...
<br><br>
								REST API URL: <a href="/<?php echo "$dir/vulnerabilities/sqli/api.php/users/2\">/servicegoat/vulnerabilities/sqli/api.php/users/2</a>"; ?>
